...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { data_da_reserva: @reserva.data_da_reserva, fim_da_reserva: @reserva.fim_da_reserva, hospede: @reserva.hospede, hotel: @reserva.hotel, quarto: @reserva.quarto } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { data_da_reserva: @reserva.data_da_reserva, fim_da_reserva: @reserva.fim_da_reserva, hospede: @reserva.hospede, hotel: @reserva.hotel, quarto: @reserva.quarto } }
